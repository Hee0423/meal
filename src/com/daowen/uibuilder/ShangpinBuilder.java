...
public class ShangpinBuilder extends UibuilderBase {
    ...
    public String  buildSameKouwei(String kouwei){
		
		StringBuilder sb=new StringBuilder();
		
		List<Shangpin> shangpinlist=getSameKouwei(kouwei);
		
		//等到商品信息
		sb.append(buildImageLanmu(shangpinlist, "推荐菜品"));
   ...
   private  List<Shangpin> getSameKouwei(String kouwei){
		
		List<Shangpin> list=DALBase.getTopList("shangpin", " where kouwei='"+kouwei+"'", 8);
