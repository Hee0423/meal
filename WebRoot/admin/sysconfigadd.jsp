...
<body>
	...
	<form name="sysconfigform" method="post"
		action="<%=SystemParam.getSiteRoot()%>/admin/sysconfigmanager.do"
		id="sysconfigForm">
		<table class="grid" cellspacing="1" width="100%">
			...
			<tr>
				...
				<td><input name="title"
					validate="{required:true,messages:{required:'请输入信息标题'}}"
					value="${requestScope.sysconfig.title}" class="input-txt"
					type="text" id="txtTitle" /></td>
			</tr>
			<tr>
				<td align="right">内容:</td>
				<td colspan="3"><textarea name="dcontent" id="txtDcontent"
						style="width:98%;height:500px;">${requestScope.sysconfig.dcontent}</textarea>
				</td>
			</tr>
		</table>
		<div >
