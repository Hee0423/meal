...
<body>
	...
	<div class="wrap">
     ...
     <div class="cartcon"  style="background-color:#fff; min-height: 600px;">
                    ...
                    <td height="34px" colspan="2">
                      <div style="height: 50px; color: rgb(136, 136, 136); line-height: 50px; font-family: 微软雅黑;
		                font-size: 18px;margin-left:90px; font-weight: 600;">
		                                                 下单成功!<a href="<%=SystemParam.getSiteRoot()%>/admin/dingdanmanager.do?actiontype=get&forwardurl=/e/huiyuan/dingdanmanager.jsp">亲继续付款吧</a>
		                </div>
                    </td>
                </tr>
