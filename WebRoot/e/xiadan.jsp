             ...
             <div class="cart_prolist">
                        ...
                        %>
                          <ul>
                            ...
                            <li style="width: 100px;"><%=dditem2.getJiage().toString() %>￥</li>
                            <li style="width: 100px;"><%=dditem2.getHyjia().toString() %>￥</li>
                            <li style="width: 120px;"> <span id="sp<%=dditem2.getSpno() %>Shuliang"> <%=dditem2.getShuliang() %></span>份
            ...
            <table class="grid" width="100%"   cellpadding="0" cellspacing="0">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                         <input style="height: 20px;" name="shrtel" runat="server" value="${huiyuan.mobile }"   class="input-txt" type="text">
                    </td>
                </tr>
               ...
               <tr>
                    ...
                    <td>
                      <input  name="shouhuodizhi"  type="text"  value="${huiyuan.address}" class="input-txt" />
                    </td>
                </tr>
                  ...
                  <tr>
                    <td colspan="2" height="34px">
		                        ...
		                        <input  class="orange-button" type="submit" value="提交订单"/>
