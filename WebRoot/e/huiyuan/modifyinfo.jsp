          ...
          $(function(){
                 ...
                 $('#btnulTouxiang').uploadify({  
			          ...
			          var imgtouxiangsrc="${huiyuan.touxiang}";
				       if(imgtouxiangsrc==""){
				         var url="<%=SystemParam.getSiteRoot()%>/e/images/nopic.jpg";
					...
					<form name="huiyuanform" method="post"
						...
						<table class="grid" cellspacing="1" width="100%">
							...
							<tr>
								...
								<td>
								${requestScope.huiyuan.accountname}
							...
							<tr>
								...
								<td><input name="zhiye"
									value="${requestScope.huiyuan.zhiye}" class="input-txt"
							...
							<tr>
								...
								<td colspan="3">
								    ...
								    <%
							   int i=0;
							   List<Kouwei> listkouwei=(List<Kouwei>)DALBase.getEntity("kouwei", "order by id asc");
							   if(listkouwei!=null){
							   for(Kouwei temkouwei :listkouwei){
								   if(i++==0){
							 %>
							 
							     <input type="radio" checked="checked" name="kouwei"  value="<%=temkouwei.getName()%>"/> <%=temkouwei.getName()%>
							  
							  <%}else{ %>
							  
							      <input type="radio" name="kouwei"  value="<%=temkouwei.getName()%>"/> <%=temkouwei.getName()%>
							  <%} %>
