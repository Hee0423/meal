...
<body style="padding:10px">
	...
	<div class="wrap">
		<div class="cover-title">
			当前位置：<a href="index.jsp">首页</a> &gt;&gt; 送餐登记
		</div>
	</div>
	<div class="fn-clear"></div>
	<div class="wrap">
			...
			<tr>
						<td colspan="4">
						 ...
						 <form name="payform" method="post" action="<%=SystemParam.getSiteRoot()%>/admin/dingdanmanager.do">
						      ...
						      <input type="hidden" name="forwardurl" value="/e/shanghu/fahuoresult.jsp"/>
						      <input type="hidden" name="ddid" value="<%=id%>"/>
						      <span  >
						          <input type="submit" class="orange-button" value="送餐完成"/>
						       </span>
