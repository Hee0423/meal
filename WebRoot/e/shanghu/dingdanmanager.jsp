							...
							<tr>
								...
								<td>
								  ...
								  %>
								   ...
								   <a href="<%=SystemParam.getSiteRoot() %>/e/shanghu/fahuo.jsp?id=<%=temdingdan.getId()%>">送餐</a>
								  <%} %>
								    <a href="<%=SystemParam.getSiteRoot() %>/e/shanghu/dingdandetails.jsp?id=<%=temdingdan.getId()%>">查看</a>
								</td>
							</tr>
